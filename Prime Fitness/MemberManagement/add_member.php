...
if ($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $email = $_POST['email'];
    $phone = $_POST['phone'];
    $memberManagement->addMember($name,$email,$phone);
}
?>
    ...
    <div class="desktop">
      <div class="overlap">
        ...
        <div class="frame-6">
          ...
          <a href=""><a href=""><div class="text-wrapper-12">Terms of Use</div></a></a>
        ...
        <div class="frame-9">
          <a href="/homepage/index.php"><div class="frame-10"><div class="text-wrapper-15">Back to homepage</div></div></a>
          <div class="overlap-2">
            <div class="frame-11">
              <div class="text-wrapper">PRIME</div>
              <div class="FITNESS-TRAINING">FITNESS &amp; TRAINING</div>
            </div>
            <div class="text-wrapper-16">Successfully member registration</div>
      </div>
    </div>
  </body>
</html>
